...
//
	 ...
	 @Transactional
	 @Modifying
		@Query("UPDATE AddAmount SET balance   = balance + :balance,userid=:userid WHERE  accountnumber = :accountnumber")
		Integer updatebalance(int balance,int accountnumber,int userid);
